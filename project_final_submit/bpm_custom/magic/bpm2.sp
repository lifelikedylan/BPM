...
Vclk  clk  gnd pulse 0 5V 0ns 200ps 200ps 6.67ns   13.33ns
Ven   en   gnd DC 5V
Vinit init gnd PWL 0 5V 13.33n 5V 13.4n 0
...
+  ad=50 pd=30 as=0 ps=0
M1370 bs1_0[0]/dffpos_0/a_56_65# delay gnd Gnd CMOSNTT w=10 l=2
+  ad=30 pd=26 as=0 ps=0
...
+  ad=100 pd=50 as=0 ps=0
M1383 bs1_0[0]/dffpos_0/a_56_9# delay vdd Vdd CMOSPTT w=20 l=2
+  ad=60 pd=46 as=0 ps=0
...
+  ad=0 pd=0 as=0 ps=0
M1404 delay bs1_0[0]/bc1a_0/inverter_1/Y cout Gnd CMOSNTT w=10 l=2
+  ad=60 pd=32 as=100 ps=60
M1405 gnd init delay Gnd CMOSNTT w=10 l=2
+  ad=0 pd=0 as=0 ps=0
M1406 delay init cout Vdd CMOSPTT w=10 l=2
+  ad=60 pd=32 as=150 ps=80
M1407 gnd bs1_0[0]/bc1a_0/inverter_1/Y delay Vdd CMOSPTT w=10 l=2
+  ad=0 pd=0 as=0 ps=0
...
**************************************************************
 ...
 .measure tran critical_path_delay
 + trig V(clk) val=2.5 rise = 1
 + targ V(q_0) val=2.5 rise = 1
...
**************************************************************
.probe V(clk) V(en) V(init)
.probe V(mplier_0) V(mcand_0) V(q_0)
.probe V(mplier_1) V(mcand_1) V(q_1)
.probe V(mplier_2) V(mcand_2) V(q_2) 
.probe V(mplier_3) V(mcand_3) V(q_3) 
.probe V(mplier_4) V(mcand_4) V(q_4) 
.probe V(mplier_5) V(mcand_5) V(q_5) 
.probe V(mplier_6) V(mcand_6) V(q_6) 
.probe V(mplier_7) V(mcand_7) V(q_7) 
.probe V(delay)
.probe V(q_8) V(q_9) V(q_10) V(q_11) V(q_12) V(q_13) V(q_14) V(q_15)
.op
