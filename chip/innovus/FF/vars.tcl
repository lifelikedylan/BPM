...
# Executed on 09:34:30 AM(Dec07) by user: dshadoa
...
global env
set env(VPATH) make
set vars(ff_exe_dir) "/home/dshadoa/Desktop/BPM/chip/innovus"
set vars(rundir) "/home/dshadoa/Desktop/BPM/chip/innovus"
...
set vars(argv) {postcts_hold}
set vars(backup_data) {0}
set vars(batch) {true}
set vars(black_box) {true}
set vars(bsteps) {postcts_hold}
...
set vars(cwd) {/home/dshadoa/Desktop/BPM/chip/innovus}
...
set vars(design_root) {/home/dshadoa/Desktop/BPM/chip/innovus/../..}
...
set vars(execute_string) {/usr/bin/tclsh /home/dshadoa/Desktop/BPM/chip/innovus/SCRIPTS/gen_flow.tcl -m flat -d FF -v 16.1.0 -s . -y none -n postcts_hold}
...
set vars(lef_files) {/classes/ecen4303F18/osu_soc_3.0/lib/ami05/lib/osu05_stdcells.lef ../abstract/bpm_custom.lef}
...
set vars(pre_cts_sdc) {/home/dshadoa/Desktop/BPM/chip/synth/mapped/bpm_pad.sdc}
...
set vars(script_path) {/home/dshadoa/Desktop/BPM/chip/innovus/SCRIPTS}
set vars(script_root) {/home/dshadoa/Desktop/BPM/chip/innovus/SCRIPTS}
set vars(seed) {1}
...
set vars(setup_func_mode,pre_cts_sdc) {/home/dshadoa/Desktop/BPM/chip/synth/mapped/bpm_pad.sdc}
set vars(setup_path) {.}
...
set vars(step_arg) {postcts_hold}
...
set vars(timelib) {}
set vars(timelib,max) {/classes/ecen4303F18/osu_soc_3.0/lib/ami05/lib/osu05_stdcells.lib}
set vars(timelib,min) {/classes/ecen4303F18/osu_soc_3.0/lib/ami05/lib/osu05_stdcells.lib}
set vars(top) {0}
set vars(top_cell) {bpm_pad}
