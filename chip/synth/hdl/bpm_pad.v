module bpm_pad (q, cout, done, mplier, mcand, reset, clk);
   ...
   fsm f (done_i, reset_i, init, en, clk_i);
   ...
   bpm_custom custom (.cout(cout_i), 
		      ...
		      .q_15(q_i[15]),        .q_14(q_i[14]), 
		      .q_13(q_i[13]),        .q_12(q_i[12]), 
		      .q_11(q_i[11]),        .q_10(q_i[10]),
		      .q_9(q_i[9]),         .q_8(q_i[8]),
		      .q_7(q_i[7]),         .q_6(q_i[6]), 
		      .q_5(q_i[5]),         .q_4(q_i[4]), 
		      .q_3(q_i[3]),         .q_2(q_i[2]),
		      .q_1(q_i[1]),         .q_0(q_i[0]),
		      .clk(clk_i), .en(en), .init(init));
   ...
   PADINC p15 (.DI(mcand_i[7]),  .YPAD(mcand[7]));
   PADINC p14 (.DI(mcand_i[6]),  .YPAD(mcand[6]));
   PADINC p13 (.DI(mcand_i[5]),  .YPAD(mcand[5]));
   PADINC p12 (.DI(mcand_i[4]),  .YPAD(mcand[4]));
   PADINC p11 (.DI(mcand_i[3]),  .YPAD(mcand[3]));
   PADINC p10 (.DI(mcand_i[2]),  .YPAD(mcand[2]));
   PADINC p09 (.DI(mcand_i[1]),  .YPAD(mcand[1]));
   PADINC p08 (.DI(mcand_i[0]),  .YPAD(mcand[0]));
